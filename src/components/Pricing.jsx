      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-2xl mx-auto items-center">
        ...
        <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-200 transform scale-105">
          <div className="p-8 text-center">
            ...
            <button className="cursor-pointer w-full py-3 text-green-600 border border-green-600 rounded-lg hover:bg-green-50 transition-colors duration-300 text-sm font-medium">
              Sign Up For Free
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-300 overflow-hidden text-black transform scale-110 relative">
          ...
          <div className="p-10 text-center">
            ...
            <p className="text-sm text-black mb-4">3 extra file uploads</p>
            <div className="mb-6">
              <span className="text-5xl font-bold text-green-950">
                <span className="text-3xl align-text-top">$</span>2.99
              </span>
            </div>
            ...
            <button className="w-full py-3 bg-green-800 text-white rounded-lg hover:bg-green-900 cursor-pointer transition-colors duration-300 font-semibold text-sm shadow-lg hover:shadow-xl">
              Get Credits
            </button>
          </div>
        </div>
